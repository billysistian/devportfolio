...
export const en = {
  ...
  hero: {
    ...
    description: 'I build accessible, pixel-perfect, and performant web applications. Passionate about creating seamless user experiences with modern technologies.',
  ...
  about: {
    ...
    title: 'Passionate Web Developer based in Bandar Lampung',
    description1: 'I specialize in building full-stack applications using modern technologies like React, Node.js, and Tailwind CSS. With a strong foundation in both frontend design and backend logic, I create seamless digital experiences that solve real-world problems.',
    description2: 'When I\'m not working, I\'m learning new technologies, improving my problem-solving skills, or building personal projects',
  ...
  projects: {
    ...
    projects: [
      {
        title: 'Presensi & Sales Visit App',
        ...
        tech: ['Laravel', 'Rest API', 'Flutter', 'MySQL'],
      },
      {
        ...
        tech: ['Next.js', 'Tailwind CSS', 'SEO Friendly', 'Supabase'],
      },
      {
        title: 'Payroll Management System',
        description: 'A comprehensive payroll management system with features for employee tracking, salary calculation, and automated reporting.',
        role: 'Fullstack Developer',
        tech: ['PHP', 'Laravel 10', 'MySQL', 'Eloquent ORM', 'Tailwind CSS', 'jQuery', 'Laravel Sanctum', 'Spatie Permission'],
      },
      {
        ...
        role: 'Fullstack Developer',
        tech: ['Next.js', 'Node.js', 'Supabase', 'Tailwind CSS', 'Shadcn UI'],
      },
      {
