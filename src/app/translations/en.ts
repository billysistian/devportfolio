...
export const en = {
  ...
  education: {
    ...
    period: "2016 - 2020",
    degreeDescription:
      "Developed strong analytical and problem-solving skills through coursework in Software Engineering, Data Structures, and Algorithms.",
    certList: [
      {
        name: "KelasFullstack",
        issuer: "Codepolitan",
  ...
  footer: {
    description:
      "Building digital products, brands, and experiences. Available for freelance projects and full-time opportunities.",
